...
/* /var/www/octo/themes/krisawzm-simply-blog/pages/blog/post.htm */
class __TwigTemplate_a86c9f68af887817dbb3ec13c3e8de7d9c47bd9ed1abbe7c3f226cc798d7998c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["url"] ?? null)) . "&amp;mini=true&amp;title=") . ($context["title"] ?? null)) . "&amp;summary=") . twig_urlencode_filter(twig_get_attribute($this->env, $this->source, ($context["post"] ?? null), "excerpt", [], "any", false, false, false, 62))) . "&amp;source=") . ($context["url"] ?? null))]];
    ...
    */
    ...
    {
        return "/var/www/octo/themes/krisawzm-simply-blog/pages/blog/post.htm";
    }
    ...
    {
        return new Source("", "/var/www/octo/themes/krisawzm-simply-blog/pages/blog/post.htm", "");
    }
}
